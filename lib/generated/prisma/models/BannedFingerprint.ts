...
// @ts-nocheck 
/*
 * This file exports the `BannedFingerprint` model and its related types.
 *
...
export type GetBannedFingerprintAggregateType<T extends BannedFingerprintAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateBannedFingerprint[P]>
    : Prisma.GetScalarType<T[P], AggregateBannedFingerprint[P]>
}
...
export type GetBannedFingerprintGroupByPayload<T extends BannedFingerprintGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<BannedFingerprintGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof BannedFingerprintGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], BannedFingerprintGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], BannedFingerprintGroupByOutputType[P]>
      }
    >
  >
...
export type BannedFingerprintWhereInput = {
  ...
  fingerprint?: Prisma.StringFilter<"BannedFingerprint"> | string
  reason?: Prisma.StringNullableFilter<"BannedFingerprint"> | string | null
  createdAt?: Prisma.DateTimeFilter<"BannedFingerprint"> | Date | string
}
...
export type BannedFingerprintScalarWhereWithAggregatesInput = {
  ...
  fingerprint?: Prisma.StringWithAggregatesFilter<"BannedFingerprint"> | string
  reason?: Prisma.StringNullableWithAggregatesFilter<"BannedFingerprint"> | string | null
  createdAt?: Prisma.DateTimeWithAggregatesFilter<"BannedFingerprint"> | Date | string
}
...
export type BannedFingerprintOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "fingerprint" | "reason" | "createdAt", ExtArgs["result"]["bannedFingerprint"]>
...
export type BannedFingerprintCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface BannedFingerprintDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends BannedFingerprintCountArgs>(
    args?: Prisma.Subset<T, BannedFingerprintCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], BannedFingerprintCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, BannedFingerprintGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetBannedFingerprintGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
...
export interface BannedFingerprintFieldRefs {
  ...
  readonly fingerprint: Prisma.FieldRef<"BannedFingerprint", 'String'>
  readonly reason: Prisma.FieldRef<"BannedFingerprint", 'String'>
  readonly createdAt: Prisma.FieldRef<"BannedFingerprint", 'DateTime'>
}
